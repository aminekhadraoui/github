		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<th>code editor</th>
							...
							echo $project;
							$query=mysqli_query($conn,"SELECT * FROM project S WHERE date=( SELECT MAX(date) FROM project WHERE pointedname = S.pointedname) and  (directoryName ='$project')")or die(mysqli_error($conn));
