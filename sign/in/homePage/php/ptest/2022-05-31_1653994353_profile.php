...
<html lang="fr">
  ...
  <div class="col-2">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home" aria-selected="false">Profile</a>
        ...
        <div class="row">
            <form class="profile-form">
                <div class="form-group">
                  <img src="../../blog/upload/images/Homme.png" class="img-fluid img-thumbnail img-circle" alt="photo de profile">
                       <div class="form-group">
                            <label for="tof">Photo de profile</label>
                            <input type="text" class="form-control" id="tof" placeholder="Entrer le nom de photo">
                      </div>
                       <div class="form-group">
                            <label for="id_user">id admin</label>
                            <input type="number" class="form-control" id="id_user" placeholder="Enter id user" disabled>
                      </div>
                       <div class="form-group">
                            <label for="id">Id profile</label>
                            <input type="text" class="form-control" id="id" placeholder="Enter id profile" disabled>
                      </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="etat_compte" placeholder="Enter etat de compte">
                      </div>
                       <div class="form-group">
                            <label for="vk">Clé de validation</label>
                            <input type="text" class="form-control" id="vk" placeholder="Entre le clé de validation">
                      </div>
                       <div class="form-group">
                            <label for="date_insc">Date d'inscription</label>
                            <input type="text" class="form-control" id="date_insc" placeholder="Entrer la date d'inscription" disabled>
                      </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sexe" placeholder="Entrer sexe">
                      </div>
                       <div class="form-group">
                            <label for="date_naiss">Date de naissance</label>
                            <input type="text" class="form-control" id="date_naiss" placeholder="Enter date">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="Telephone" placeholder="Enter Téléphone">
                      </div>
                       <div class="form-group">
                            <label for="fil">Filliére</label>
                            <input type="text" class="form-control" id="fil" placeholder="Enter filliére">
                      </div>
                       <div class="form-group">
                            <label for="grp">Groupe</label>
                            <input type="text" class="form-control" id="grp" placeholder="Enter groupe">
                      </div>
                    <div class="form-group">   
                    <label for="select1">Type admin</label>   
        ...
        <div class="container">
            ...
            <form class="center-block">
                <div class="form-group ">
                    ...
                    <button class="btn btn-outline-primary" id='notification'>Envoyer</button>
                </div>
                </form>
            <!--end notification-->
            <!--start messages-->
