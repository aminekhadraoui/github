...
<div style="padding-left:10px;padding-right:10px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;text-align:center;font-weight: bold;padding-top:20px;padding-bottom:20px;position:fixed;width:250px;height:300px;background:white;color:black;right:35%;margin-top:60px;">
<div id="output">
 </div>
    </div>
      ...
      <i class="fas fa-bell"></i>
            ...
            <div class="body_box_notification" >
                <?php 
                    // notification
                    $queryu = "SELECT id_user FROM `user` WHERE `adresse_user`='$mail';";
                    $myquery = mysqli_query($conn,$queryu);
                    $nbrr=mysqli_num_rows($myquery);
                    if ($nbrr >0){
                        $data=mysqli_fetch_array($myquery);
                        $id = $data[0];
                        $select_notif = "select * from notification where `id_user`='$id' ORDER BY `date_notif` DESC";
                       ...
                       <table class='table-notification'>
                            <tr>
                                ...
                                <img alt='photo de profile' src='upload/images/notification.svg' width='50'></td>
                                <td class='tb-notification'><b><font size='2' style='margin-left:1%;'>Notification</font></b></td>
                            </tr>
                            <tr>
...
<!--start box_post-->        
          ...
          <div class="add_publication">
            ...
            <div class="body_add_publication" id="pub">
            <form name="formpub" method="post" enctype="multipart/form-data" action="insert_pub.php"
                >
   ...
   if ($ress = mysqli_query($conn, $query2))
    {
        ...
        while($pub=mysqli_fetch_array($ress)) 
        {
            ...
            if ($pub[7] != "")
            $file_publication = "upload/files/".$pub[7];
            else $file_publication = "";
           ...
           $x=$k."f";
            ...
            echo " <div id='$updatepub'>
                            ...
                            <div class='titre_box_post'>
                                <div class='option'>
                                    ...
                                    <ul class='submenu' id='$idselect'>
                                        ...
                                        <li>
                                            <a href='#' onclick='return removeOption(`$idremoveselect`);' >supprimer la publication
                                            </a>
                                        </li>
                                  </ul>
                             </div>
                        ...
                        <div class='body_box_post'>
                            ...
                            <h4 id='fileTitle' onclick='openFile(`$file_publication`)' style='padding-Left:20px;color:blue;cursor: pointer;'>&nbsp; View file</h4>
